...
class PemasukanResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('sumber_pemasukan')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('jumlah_pemasukan')
                    ->required()
                    ->numeric(),
                Forms\Components\DatePicker::make('tanggal_pemasukan')
                    ->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('sumber_pemasukan')
                    ->searchable(),
                Tables\Columns\TextColumn::make('jumlah_pemasukan')
                    ->numeric()
                    ->sortable(),
